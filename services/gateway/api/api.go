...
func SetUpAPI(r *gin.Engine, h handlers.Handler, cfg config.BaseConfig, tracer opentracing.Tracer, tracker *apilimits.Tracker) {
	...
	// Public KP prototypes use an unguessable 72-bit public ID generated by the
	// agent. The gateway proxies only this read-only HTML route.
	r.GET("/v1/kp-prototypes/:publicId/", h.V1.GetKpPrototype)
	...
	v1.Use(tracker.ApiCallCountMiddleware())
	{
		...
		v1.GET("/pricing/company-stats", h.V1.GetCompanyStats)
